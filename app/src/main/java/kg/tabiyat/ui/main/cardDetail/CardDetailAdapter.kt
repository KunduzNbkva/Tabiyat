...
import kg.tabiyat.databinding.ExSubListBinding


class CardDetailAdapter(private var list: ArrayList<String>) :
    RecyclerView.Adapter<CardDetailAdapter.ObservationAddHolder>() {
