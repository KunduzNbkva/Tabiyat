package com.example.tabiyat.ui.main.map.adapter
...
class ExpandableAdapter(
    ...
    override fun getGroupView(
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.ex_list, null)
        }
        val title = convertView?.findViewById<TextView>(R.id.map_ex_list_title)
